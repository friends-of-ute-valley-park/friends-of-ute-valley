      ...
      <div class="text-lg max-w-prose mx-auto mb-6">
        ...
        <div class="mt-6 sm:flex sm:justify-between">
          <div class="sm:flex">
            ...
            <span v-if="volunteerEvent.meetingLocation.notes" class="ml-1 text-gray-500 text-sm max-w-xs">{{ volunteerEvent.meetingLocation.notes }}</span>
          </div>
...
export default {
  ...
  head () {
    return {
      title: this.volunteerEvent ? this.volunteerEvent.title : '',
      meta: [
        {
          name: 'twitter:card',
