  ...
  <div class="flex w-full flex-none justify-between gap-x-4 sm:w-auto">
    <div class="flex h-12">
      <a
        ...
        class="inline-flex items-center rounded-md border border-transparent bg-green-600 px-2 py-1 text-sm font-medium text-green-50 shadow-xs transition duration-150 ease-in-out hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
        Register
      </a>
    </div>
    <div class="flex h-12 gap-x-2.5">
      <a
        ...
        class="inline-flex items-center rounded-md border border-transparent bg-teal-600 px-2 py-1 text-sm font-medium text-teal-50 shadow-xs transition duration-150 ease-in-out hover:bg-teal-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600">
